...
public class MyItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        final MainAdapter.TestViewHolder holder = (MainAdapter.TestViewHolder) newHolder;
        ...
        ObjectAnimator oldTextRotate = ObjectAnimator.ofFloat(holder.itemView, View.ROTATION_Y, 0, 90);
        ObjectAnimator newTextRotate = ObjectAnimator.ofFloat(holder.itemView, View.ROTATION_Y, -90, 0);
        oldTextRotate.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationStart(Animator animation) {
                holder.testName.setText(preColorTextInfo.text);
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                holder.testName.setText(postColorTextInfo.text);
            }
        });
    ...
    private class ColorTextInfo extends ItemHolderInfo {
        ...
        public ItemHolderInfo setFrom(RecyclerView.ViewHolder holder) {
            if (holder instanceof MainAdapter.TestViewHolder) {
                MainAdapter.TestViewHolder colorViewHolder = (MainAdapter.TestViewHolder) holder;
                color = ((ColorDrawable) colorViewHolder.itemView.getBackground()).getColor();
                text = (String) colorViewHolder.testName.getText();
            }
